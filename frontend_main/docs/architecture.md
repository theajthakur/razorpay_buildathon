...
- **Route Group Isolation**: Authenticated pages live inside `app/(dashboard)` sharing a common sidebar layout, header with merchant profile, and generous main content canvas.
