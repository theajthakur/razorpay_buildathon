...
class Onboarding(Base):
    ...
    auth_needed = Column(Boolean, default=False, nullable=False)
    auth_method = Column(String, nullable=True)  # apikey | bearer | basic
    credential_value = Column(String, nullable=True)
    
    # Store endpoints mapping object: e.g. { "products": { "path": "products", "method": "GET" }, ... }
    endpoints = Column(JSON, nullable=False, default=dict)
